(function (f) {
  ...
  return (function () {
    ...
    7: [function (require, module, exports) {
      ...
      "@turf/bbox": 8,
      "@turf/boolean-point-in-polygon": 3,
      "rbush": 19
    }],
      ...
      (function (global, factory) {
        ...
        function projectionMutator(projectAt) {
          var project,
            ...
            x0 = null,
            y0, x1, y1, postclip = identity, // clip extent
            delta2 = 0.5,
          ...
          projection.clipExtent = function (_) {
            return arguments.length ? (postclip = _ == null ? (x0 = y0 = x1 = y1 = null, identity) : clipExtent(x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0], y1 = +_[1][1]), reset()) : x0 == null ? null : [
              [x0, y0],
              [x1, y1]
            ];
          };
        ...
        var identity$1 = function () {
          var k = 1,
            ...
            x0 = null,
            y0, x1, y1, clip = identity, // clip extent
            cache,
            cacheStream,
            projection;
          ...
          return projection = {
            ...
            clipExtent: function (_) {
              return arguments.length ? (clip = _ == null ? (x0 = y0 = x1 = y1 = null, identity) : clipExtent(x0 = +_[0][0], y0 = +_[0][1], x1 = +_[1][0], y1 = +_[1][1]), reset()) : x0 == null ? null : [
                [x0, y0],
                [x1, y1]
              ];
            },
      ...
      ! function (t, e) {
        ...
        st.prototype.countSegment = function (t, e) {
          ...
          if (arguments[0] instanceof C && T(arguments[1], V)) {
            for (var t = arguments[0], e = arguments[1], n = new st(t), i = new C, r = new C, o = 1; o < e.size(); o++)
          ...
          if (2 === arguments.length) {
            ...
            if (T(arguments[2], Ke) && arguments[0] instanceof Object && arguments[1] instanceof Qe)
              for (var r = arguments[0], o = arguments[1], s = arguments[2], a = o.getChildBoundables(), u = 0; u < a.size(); u++) {
                ...
                for (var c = arguments[0], p = arguments[1], h = arguments[2], f = p.getChildBoundables(), g = 0; g < f.size(); g++) {
                  var d = f.get(g);
          ...
          if (3 === arguments.length)
            if (T(arguments[2], xt) && arguments[0] instanceof C && arguments[1] instanceof ze)
              for (var o = arguments[0], s = arguments[1], a = arguments[2], u = s.getEdge().getCoordinates(), l = 0; l < u.length - 1; l++) {
                ...
                for (var h = arguments[0], f = arguments[1], g = arguments[2], d = f.iterator(); d.hasNext();) {
                  var y = d.next();
        ...
        mi.prototype.interfaces_ = function () {
          ...
          if (arguments[2] instanceof _i && arguments[0] instanceof Kt && arguments[1] instanceof C)
            ...
            var p = arguments[0],
              h = arguments[1],
              f = arguments[2];
            if (p instanceof Kt) mi.computeDistance(p, h, f);
            else if (p instanceof $t) mi.computeDistance(p, h, f);
